      ...
      <div className="min-h-screen bg-gradient-to-br from-blue-50 via-white to-purple-50 dark:from-gray-900 dark:via-gray-800 dark:to-gray-900">
        ...
        <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-12">
            {experts.map((expert) => {
              const Icon = expert.id === "hangzhou-zhongkao" ? GraduationCap : BookOpen;
              return (
                <Link
                  key={expert.id}
                ...
                >
                  <div
                    className="bg-white dark:bg-gray-800 rounded-2xl shadow-lg hover:shadow-xl border-2 border-transparent hover:border-blue-400 dark:hover:border-blue-600 transition-all duration-300 p-6 overflow-hidden relative"
                    style={{ borderColor: darkMode ? undefined : undefined }}
                  >
                    <div
                      className="absolute top-0 right-0 w-32 h-32 bg-blue-100 dark:bg-blue-900/30 rounded-full -translate-y-16 translate-x-16 opacity-50"
                    ...
                    <div className="relative">
                      <div className="flex items-start gap-4 mb-4">
                        ...
                        <div className="flex-1">
                          ...
                          <p className="text-sm text-gray-500 dark:text-gray-400 mt-1">
                            {expert.id === "hangzhou-zhongkao" ? "杭州中考志愿填报" : "浙江新高考选科与志愿"}
                          </p>
                        </div>
                      </div>
                      ...
                      <div className="flex items-center gap-2 font-medium" style={{ color: expert.color }}>
                        <span>开始咨询</span>
